// Package config provides configuration management utilities for the OUI panel,
...
// GetVersion returns the version string of the OUI application.
func GetVersion() string {
	return strings.TrimSpace(version)
}

// GetName returns the name of the OUI application.
func GetName() string {
