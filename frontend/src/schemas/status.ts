...
export const ServerInfoSchema = z.object({
  ...
  nodeAlias: z.string().optional(),
  nodeLocation: z.string().optional(),
  plan: z.string().optional(),
  planMonthlyData: z.number().optional(),
  planDisk: z.number().optional(),
  planRam: z.number().optional(),
  planSwap: z.number().optional(),
  email: z.string().optional(),
  dataCounter: z.number().optional(),
  dataNextReset: z.number().optional(),
  ipAddresses: z.array(z.string()).optional(),
  rdnsApiAvailable: z.boolean().optional(),
  ptr: z.record(z.string(), z.string()).optional(),
