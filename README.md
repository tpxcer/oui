...
- TG 更新菜单会显示最新版号和本版本中文更新内容；从 TG 发起更新后，开始更新和更新成功反馈也会带上版本说明。
...
面板支持检测 GitHub Release 最新版本，并在发现新版本时从页面发起后台更新。每个正式版本都应维护中文更新说明，面板检测更新、网页一键更新确认弹窗、Telegram 更新菜单和 Telegram 更新反馈都会同步展示本版本更新内容。
